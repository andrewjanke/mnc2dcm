...
# $Id: VRfields.pm,v 1.2 2009/03/10 10:05:20 rotor Exp $
...
%VR = (
   ...
   'LO' => ['Long String',                46,  0,  0,  0],
   'LT' => ['Long Text',               10420,  0,  0,  0],
   'OB' => ['Other Byte String',           0,  0,  0,  0],
   'OW' => ['Other Word String',           0,  0,  0,  1],
   'PN' => ['Person Name',                46,  0,  0,  0],
   'SH' => ['Short String',                1,  6,  0,  0],
   'SL' => ['Signed Long',                41,  1,  1,  0],
   'SQ' => ['Sequence of Items',           0,  0,  0,  0],
   'SS' => ['Signed Short',                2,  1,  1,  1],
   'ST' => ['Short Text',               1204,  0,  0,  0],
   'TM' => ['Time',                       16,  0,  0,  0],
